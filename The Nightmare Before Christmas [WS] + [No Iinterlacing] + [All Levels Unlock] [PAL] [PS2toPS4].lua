-- Tim Burton's The Nightmare Before Christmas Oogie's Revenge(PAL-E)(SLES-53192)
-- Widescreen Hack by El_Patas
-- no interlace by Second Reality @PCSX2 forums port to PAL
...
--Max Health
eeObj.WriteMem32(0x2048DC94,0x0000001E)

--Infinite Health 
eeObj.WriteMem32(0x2048DC98,0x0000001E)

--Max Soul Robber Level
eeObj.WriteMem32(0x2048DC9C,0x00000002)

--Max Souls
eeObj.WriteMem32(0x2048DCD4,0x0001869F)

--Infinite Blue Souls
eeObj.WriteMem32(0x2048DCE4,0x00000009)

--Infinite Red Souls
eeObj.WriteMem32(0x2048DD34,0x00000032)

--4 Crystal Skulls
--eeObj.WriteMem32(0x2048DD4C,0x00000004)

--Infinite Crystal Skull
eeObj.WriteMem32(0x2048DD4C,0x00000009)
