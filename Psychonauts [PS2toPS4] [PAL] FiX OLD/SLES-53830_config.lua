...
eeObj.AddHook(0x25f4b4, 0x8de40068, adjustMapZHook) -- \/
eeObj.AddHook(0x25f574, 0xe7b500cc, adjustMapZHook) -- /\
eeObj.AddHook(0x25f630, 0xe7b500cc, adjustMapZHook) -- <
eeObj.AddHook(0x25f6f4, 0x46000386, adjustMapZHook) -- >
...
eeObj.AddHookJT(0x208538, 0x27bdfff0, advanceClockForGame) -- <GameApp::EndFrame()>:


local widescreen = function()

-- Widescreen
eeObj.WriteMem32(0x001ea96c,0x3c013f40) --00000000 (horizontal fov)
eeObj.WriteMem32(0x001ea970,0x4481f800) --00000000
eeObj.WriteMem32(0x001ea974,0x461f3183) --46061983
eeObj.WriteMem32(0x001ea98c,0x46061983) --00000000

-- Render Fix
eeObj.WriteMem32(0x001e90c4,0x340f02ab) --962f0038
eeObj.WriteMem32(0x001292d8,0x240e02ab) --240e0200

-- Remove post processing (fixes bad ghosting in PCSX2 hardware mode)
eeObj.WriteMem32(0x0036d2d4,0x00000000)
