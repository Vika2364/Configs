-- Resident Evil 4 Ashley Femele V2 [MOD] (U)
-- emu used=KOF 98
...
if (L3 ~= 0) then
-- Infinite Health Leon (or any other main Character)
eeObj.WriteMem32(0x001c27f8,0x00401023)
end
if (UP ~= 0 and Select ~= 0) then
-- Chicago Typewriter
eeObj.WriteMem32(0x2042DA82,0x0000000C)
end
if (DOWN ~= 0 and Select ~= 0) then
-- Shotgun
eeObj.WriteMem32(0x2042DA82,0x00000007)
end
if (LEFT ~= 0 and Select ~= 0) then
-- TMP
eeObj.WriteMem32(0x2042DA82,0x0000000B)
end
if (RIGHT ~= 0 and Select ~= 0) then
-- Matilda
eeObj.WriteMem32(0x2042DA82,0x00000011)
end
if (R3 ~= 0) then
-- Unlimited Ammo
eeObj.WriteMem32(0x201200AC,0x00000000)
end
